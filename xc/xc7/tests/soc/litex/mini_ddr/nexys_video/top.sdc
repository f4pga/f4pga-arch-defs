...
# PLL CLKOUT3
create_clock -period 5 main_clkout_buf3 -waveform {0.000 2.500}

set_clock_groups -exclusive -group {main_clkin} -group {main_clkout0 sys_clk} -group {main_clkout1 main_clkout2 sys4x_dqs_clk sys4x_clk} -group {main_clkout_buf3}
