function(icestorm_setup)
  ...
  set(ICESTORM_SRC ${f4pga-arch-defs_SOURCE_DIR}/third_party/icestorm CACHE PATH "Path to icestorm repository")
  set(PYUTILS_PATH ${f4pga-arch-defs_SOURCE_DIR}/utils:${f4pga-arch-defs_SOURCE_DIR}/lattice/ice40/utils/fasm_icebox)

  set(FASM2ASC ${f4pga-arch-defs_SOURCE_DIR}/lattice/ice40/utils/fasm_icebox/fasm2asc.py)
  add_custom_target(
    fasm2asc_deps
  ...
  set_target_properties(
    ice40_import_timing_deps
    PROPERTIES ICE40_IMPORT_TIMING ${f4pga-arch-defs_SOURCE_DIR}/lattice/ice40/utils/ice40_import_bel_timing.py
    )
