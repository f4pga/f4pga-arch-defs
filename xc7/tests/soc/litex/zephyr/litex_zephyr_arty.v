//--------------------------------------------------------------------------------
// Auto-generated by Migen (d11565a) & LiteX (02bfda5e) on 2020-02-11 15:05:14
//--------------------------------------------------------------------------------
module top(
...
assign main_ram_adr = main_ram_bus_adr[14:0];
...
always @(*) begin
	...
	slave_sel[1] <= (shared_adr[28:13] == 14'd8192);
	slave_sel[2] <= (shared_adr[28:15] == 14'd8192);
	slave_sel[3] <= (shared_adr[28:22] == 7'd96);
end
...
assign xilinxasyncresetsynchronizerimpl = ((~pll_locked) | (~cpu_reset));
