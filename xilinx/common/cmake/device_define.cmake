function(ADD_XC_BOARD)
  ...
  if(${USE_ROI})
    ...
    get_target_property_required(SYNTH_TILES ${DEVICE_TYPE} SYNTH_TILES)
    get_file_location(SYNTH_TILES_LOCATION ${SYNTH_TILES})
    set(CREATE_PINMAP_CSV ${symbiflow-arch-defs_SOURCE_DIR}/xilinx/common/utils/prjxray_create_pinmap_csv.py)
...
function(ADD_XC_DEVICE_DEFINE_TYPE)
  ...
  set(UPDATE_PACK_PATTERNS ${symbiflow-arch-defs_SOURCE_DIR}/xilinx/common/utils/add_pack_patterns.py)
  set(PYTHON_SDF_TIMING_DIR ${symbiflow-arch-defs_SOURCE_DIR}/third_party/python-sdf-timing)
  set(BELS_MAP ${symbiflow-arch-defs_SOURCE_DIR}/xilinx/${FAMILY}/bels.json)
