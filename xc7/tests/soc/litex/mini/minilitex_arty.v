//--------------------------------------------------------------------------------
// Auto-generated by Migen (8d0e740) & LiteX (60f2853e) on 2019-12-09 09:58:48
//--------------------------------------------------------------------------------
module top(
...
assign vexriscv_ibus_dat_r = shared_dat_r;
assign vexriscv_dbus_dat_r = shared_dat_r;
assign vexriscv_ibus_ack = (shared_ack & (grant == 1'd0));
assign vexriscv_dbus_ack = (shared_ack & (grant == 1'd1));
assign vexriscv_ibus_err = (shared_err & (grant == 1'd0));
assign vexriscv_dbus_err = (shared_err & (grant == 1'd1));
assign request = {vexriscv_dbus_cyc, vexriscv_ibus_cyc};
always @(*) begin
	slave_sel <= 3'd0;
...
assign csrbankarray_csrbank0_scratch3_w = ctrl_storage_full[31:24];
assign csrbankarray_csrbank0_scratch2_w = ctrl_storage_full[23:16];
assign csrbankarray_csrbank0_scratch1_w = ctrl_storage_full[15:8];
assign csrbankarray_csrbank0_scratch0_w = ctrl_storage_full[7:0];
...
assign timer0_update_value_r = csrbankarray_interface1_bank_bus_dat_w[0];
assign timer0_update_value_re = ((csrbankarray_csrbank1_sel & csrbankarray_interface1_bank_bus_we) & (csrbankarray_interface1_bank_bus_adr[4:0] == 4'd9));
...
assign csrbankarray_csrbank1_load3_w = timer0_load_storage_full[31:24];
assign csrbankarray_csrbank1_load2_w = timer0_load_storage_full[23:16];
assign csrbankarray_csrbank1_load1_w = timer0_load_storage_full[15:8];
assign csrbankarray_csrbank1_load0_w = timer0_load_storage_full[7:0];
assign timer0_reload_storage = timer0_reload_storage_full[31:0];
assign csrbankarray_csrbank1_reload3_w = timer0_reload_storage_full[31:24];
assign csrbankarray_csrbank1_reload2_w = timer0_reload_storage_full[23:16];
assign csrbankarray_csrbank1_reload1_w = timer0_reload_storage_full[15:8];
assign csrbankarray_csrbank1_reload0_w = timer0_reload_storage_full[7:0];
assign timer0_en_storage = timer0_en_storage_full;
assign csrbankarray_csrbank1_en0_w = timer0_en_storage_full;
...
assign csrbankarray_csrbank1_ev_enable0_w = timer0_eventmanager_storage_full;
...
assign csrbankarray_csrbank2_ev_enable0_w = uart_eventmanager_storage_full[1:0];
...
assign csrbankarray_csrbank3_tuning_word3_w = uart_phy_storage_full[31:24];
assign csrbankarray_csrbank3_tuning_word2_w = uart_phy_storage_full[23:16];
assign csrbankarray_csrbank3_tuning_word1_w = uart_phy_storage_full[15:8];
assign csrbankarray_csrbank3_tuning_word0_w = uart_phy_storage_full[7:0];
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed0 <= vexriscv_ibus_adr;
		end
		default: begin
			array_muxed0 <= vexriscv_dbus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed1 <= vexriscv_ibus_dat_w;
		end
		default: begin
			array_muxed1 <= vexriscv_dbus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed2 <= vexriscv_ibus_sel;
		end
		default: begin
			array_muxed2 <= vexriscv_dbus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed3 <= vexriscv_ibus_cyc;
		end
		default: begin
			array_muxed3 <= vexriscv_dbus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed4 <= vexriscv_ibus_stb;
		end
		default: begin
			array_muxed4 <= vexriscv_dbus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed5 <= vexriscv_ibus_we;
		end
		default: begin
			array_muxed5 <= vexriscv_dbus_we;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed6 <= vexriscv_ibus_cti;
		end
		default: begin
			array_muxed6 <= vexriscv_dbus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed7 <= vexriscv_ibus_bte;
		end
		default: begin
			array_muxed7 <= vexriscv_dbus_bte;
		end
	endcase
end
...
always @(posedge sys_clk) begin
	...
	if (csrbankarray_csrbank0_scratch3_re) begin
		ctrl_storage_full[31:24] <= csrbankarray_csrbank0_scratch3_r;
	end
	if (csrbankarray_csrbank0_scratch2_re) begin
		ctrl_storage_full[23:16] <= csrbankarray_csrbank0_scratch2_r;
	end
	if (csrbankarray_csrbank0_scratch1_re) begin
		ctrl_storage_full[15:8] <= csrbankarray_csrbank0_scratch1_r;
	end
	if (csrbankarray_csrbank0_scratch0_re) begin
		ctrl_storage_full[7:0] <= csrbankarray_csrbank0_scratch0_r;
	end
	...
	if (csrbankarray_csrbank1_sel) begin
		case (csrbankarray_interface1_bank_bus_adr[4:0])
			...
			4'd9: begin
				csrbankarray_interface1_bank_bus_dat_r <= timer0_update_value_w;
			end
			4'd10: begin
	...
	if (csrbankarray_csrbank1_load3_re) begin
		timer0_load_storage_full[31:24] <= csrbankarray_csrbank1_load3_r;
	end
	if (csrbankarray_csrbank1_load2_re) begin
		timer0_load_storage_full[23:16] <= csrbankarray_csrbank1_load2_r;
	end
	if (csrbankarray_csrbank1_load1_re) begin
		timer0_load_storage_full[15:8] <= csrbankarray_csrbank1_load1_r;
	end
	if (csrbankarray_csrbank1_load0_re) begin
		timer0_load_storage_full[7:0] <= csrbankarray_csrbank1_load0_r;
	end
	timer0_load_re <= csrbankarray_csrbank1_load0_re;
	if (csrbankarray_csrbank1_reload3_re) begin
		timer0_reload_storage_full[31:24] <= csrbankarray_csrbank1_reload3_r;
	end
	if (csrbankarray_csrbank1_reload2_re) begin
		timer0_reload_storage_full[23:16] <= csrbankarray_csrbank1_reload2_r;
	end
	if (csrbankarray_csrbank1_reload1_re) begin
		timer0_reload_storage_full[15:8] <= csrbankarray_csrbank1_reload1_r;
	end
	if (csrbankarray_csrbank1_reload0_re) begin
		timer0_reload_storage_full[7:0] <= csrbankarray_csrbank1_reload0_r;
	end
	timer0_reload_re <= csrbankarray_csrbank1_reload0_re;
	if (csrbankarray_csrbank1_en0_re) begin
		timer0_en_storage_full <= csrbankarray_csrbank1_en0_r;
	end
	timer0_en_re <= csrbankarray_csrbank1_en0_re;
	if (csrbankarray_csrbank1_ev_enable0_re) begin
		timer0_eventmanager_storage_full <= csrbankarray_csrbank1_ev_enable0_r;
	end
	...
	if (csrbankarray_csrbank2_ev_enable0_re) begin
		uart_eventmanager_storage_full[1:0] <= csrbankarray_csrbank2_ev_enable0_r;
	end
	...
	if (csrbankarray_csrbank3_tuning_word3_re) begin
		uart_phy_storage_full[31:24] <= csrbankarray_csrbank3_tuning_word3_r;
	end
	if (csrbankarray_csrbank3_tuning_word2_re) begin
		uart_phy_storage_full[23:16] <= csrbankarray_csrbank3_tuning_word2_r;
	end
	if (csrbankarray_csrbank3_tuning_word1_re) begin
		uart_phy_storage_full[15:8] <= csrbankarray_csrbank3_tuning_word1_r;
	end
	if (csrbankarray_csrbank3_tuning_word0_re) begin
		uart_phy_storage_full[7:0] <= csrbankarray_csrbank3_tuning_word0_r;
	end
