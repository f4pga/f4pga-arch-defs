function(icestorm_setup)
  ...
  set(PYUTILS_PATH ${symbiflow-arch-defs_SOURCE_DIR}/utils:${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/utils/fasm_icebox)

  set(FASM2ASC ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/utils/fasm_icebox/fasm2asc.py)
  add_custom_target(
    fasm2asc_deps
  ...
  set_target_properties(
    ice40_import_timing_deps
    PROPERTIES ICE40_IMPORT_TIMING ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/utils/ice40_import_bel_timing.py
    )
  ...
  define_arch(
    ARCH ice40
    YOSYS_SYNTH_SCRIPT ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/yosys/synth.tcl
    YOSYS_CONV_SCRIPT ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/yosys/conv.tcl
    ...
    RR_PATCH_TOOL
      ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/utils/ice40_import_routing_from_icebox.py
    ...
    PLACE_TOOL
      ${symbiflow-arch-defs_SOURCE_DIR}/lattice/ice40/utils/ice40_create_ioplace.py
