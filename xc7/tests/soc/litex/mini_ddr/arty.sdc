...
set_clock_groups -exclusive -group {clk100 main_pll_clkin__main_clkin builder_pll_fb} -group {main_clkout0 sys_clk__VexRiscv.IBusCachedPlugin_cache.clk__VexRiscv.clk__main_clkout_buf0} -group {main_clkout1 main_clkout2 sys4x_dqs_clk__main_clkout_buf2 sys4x_clkb__main_clkout_buf4 sys4x_clk__main_clkout_buf1}
