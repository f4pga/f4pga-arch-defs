...
set_clock_groups -exclusive -group {clk100 main_pll_clkin} -group {main_clkout0 sys_clk} -group {main_clkout1 main_clkout2 sys4x_dqs_clk sys4x_clk} -group {main_clkout3 clk200_clk}
