...
define_arch(
  ...
  \${PYTHON3} \${FASM_TO_BIT} \
  --db-root ${PRJXRAY_DB_DIR}/zynq7  \
  --sparse \
  \${OUT_FASM} \${OUT_BITSTREAM}"
  BIT_TO_BIN xc7patch
  BIT_TO_BIN_CMD "xc7patch \
  --part_name ${ROI_PART} \
  --part_file ${PRJXRAY_DB_DIR}/zynq7/${ROI_PART}.yaml \
...
set_target_properties(zynq7 PROPERTIES VPR_ARCH_ARGS "${VPR_ZYNQ7_ARCH_ARGS}")
