...
module	top(i_clk_100mhz,
		// Internal wishbone connections
		i_wb_cyc, i_wb_data_stb, i_wb_ctrl_stb, i_wb_we,
		i_wb_addr, i_wb_data_in,
		// Wishbone return values
		o_wb_ack, o_wb_stall, o_wb_data_out,
	...
	input		[3:0]	i_wb_data_in;
	// then outputs
	output	reg		o_wb_ack;
	output	reg		o_wb_stall;
	output o_wb_data_out;
//output	reg	[31:0]	wb_data_out;
	...
	assign	spif_sector = spif_addr[(ADDRESS_WIDTH-3):14];
        assign i_wb_data = {8{i_wb_data_in}};
...
`endif //	!READ_ONLY
	...
	assign o_wb_data_out = !(o_wb_data[31:0]) ;
endmodule
