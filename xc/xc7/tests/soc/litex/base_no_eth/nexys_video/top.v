//--------------------------------------------------------------------------------
// Auto-generated by Migen (3f9809b) & LiteX (536ae0e6) on 2020-04-16 09:05:21
//--------------------------------------------------------------------------------
module top(
...
reg [31:0] main_basesoc_storage = 32'd4947802;
...
assign clk100_clk = main_clkout_buf4;
always @(*) begin
...
assign main_adr = {main_tag_do_tag, main_wb_sdram_adr[10:2]};
always @(*) begin
...
always @(*) begin
	...
	case (builder_litedramwishbone2native_state)
		...
		default: begin
			...
			main_port_cmd_payload_addr <= (((main_adr * 1'd1) + main_count) - 27'd67108864);
...
assign main_basesoc_cpu_ibus_dat_r = builder_shared_dat_r;
assign main_basesoc_cpu_dbus_dat_r = builder_shared_dat_r;
assign main_basesoc_cpu_ibus_ack = (builder_shared_ack & (builder_grant == 1'd0));
assign main_basesoc_cpu_dbus_ack = (builder_shared_ack & (builder_grant == 1'd1));
assign main_basesoc_cpu_ibus_err = (builder_shared_err & (builder_grant == 1'd0));
assign main_basesoc_cpu_dbus_err = (builder_shared_err & (builder_grant == 1'd1));
assign builder_request = {main_basesoc_cpu_dbus_cyc, main_basesoc_cpu_ibus_cyc};
always @(*) begin
	...
	builder_slave_sel[3] <= (builder_shared_adr[29:27] == 2'd2);
end
...
assign main_wb_sdram_cyc = (builder_shared_cyc & builder_slave_sel[3]);
assign builder_shared_err = (((main_basesoc_basesoc_ram_bus_err | main_basesoc_ram_bus_ram_bus_err) | main_basesoc_bus_wishbone_err) | main_wb_sdram_err);
assign builder_wait = ((builder_shared_stb & builder_shared_cyc) & (~builder_shared_ack));
always @(*) begin
	builder_shared_dat_r <= 32'd0;
	builder_shared_ack <= 1'd0;
	builder_error <= 1'd0;
	builder_shared_ack <= (((main_basesoc_basesoc_ram_bus_ack | main_basesoc_ram_bus_ram_bus_ack) | main_basesoc_bus_wishbone_ack) | main_wb_sdram_ack);
	builder_shared_dat_r <= (((({32{builder_slave_sel_r[0]}} & main_basesoc_basesoc_ram_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_basesoc_ram_bus_ram_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & main_basesoc_bus_wishbone_dat_r)) | ({32{builder_slave_sel_r[3]}} & main_wb_sdram_dat_r));
...
assign builder_csrbank1_half_sys8x_taps0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank1_half_sys8x_taps0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 1'd0));
assign main_a7ddrphy_cdly_rst_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_cdly_rst_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 1'd1));
assign main_a7ddrphy_cdly_rst_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 1'd1));
assign main_a7ddrphy_cdly_inc_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_cdly_inc_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 2'd2));
assign main_a7ddrphy_cdly_inc_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank1_dly_sel0_r = builder_interface1_bank_bus_dat_w[1:0];
assign builder_csrbank1_dly_sel0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank1_dly_sel0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 2'd3));
assign main_a7ddrphy_rdly_dq_rst_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_rdly_dq_rst_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
assign main_a7ddrphy_rdly_dq_rst_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd4));
assign main_a7ddrphy_rdly_dq_inc_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_rdly_dq_inc_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd5));
assign main_a7ddrphy_rdly_dq_inc_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd5));
assign main_a7ddrphy_rdly_dq_bitslip_rst_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_rdly_dq_bitslip_rst_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd6));
assign main_a7ddrphy_rdly_dq_bitslip_rst_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd6));
assign main_a7ddrphy_rdly_dq_bitslip_r = builder_interface1_bank_bus_dat_w[0];
assign main_a7ddrphy_rdly_dq_bitslip_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[2:0] == 3'd7));
assign main_a7ddrphy_rdly_dq_bitslip_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[2:0] == 3'd7));
...
assign builder_csrbank2_dfii_pi0_address1_w = main_sdram_phaseinjector0_address_storage[14:8];
...
assign builder_csrbank2_dfii_pi1_address1_w = main_sdram_phaseinjector1_address_storage[14:8];
...
assign builder_csrbank2_dfii_pi2_address1_w = main_sdram_phaseinjector2_address_storage[14:8];
...
assign builder_csrbank2_dfii_pi3_address1_w = main_sdram_phaseinjector3_address_storage[14:8];
...
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed36 <= main_basesoc_cpu_ibus_adr;
		end
		default: begin
			builder_rhs_array_muxed36 <= main_basesoc_cpu_dbus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed37 <= main_basesoc_cpu_ibus_dat_w;
		end
		default: begin
			builder_rhs_array_muxed37 <= main_basesoc_cpu_dbus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed38 <= main_basesoc_cpu_ibus_sel;
		end
		default: begin
			builder_rhs_array_muxed38 <= main_basesoc_cpu_dbus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed39 <= main_basesoc_cpu_ibus_cyc;
		end
		default: begin
			builder_rhs_array_muxed39 <= main_basesoc_cpu_dbus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed40 <= main_basesoc_cpu_ibus_stb;
		end
		default: begin
			builder_rhs_array_muxed40 <= main_basesoc_cpu_dbus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed41 <= main_basesoc_cpu_ibus_we;
		end
		default: begin
			builder_rhs_array_muxed41 <= main_basesoc_cpu_dbus_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed42 <= main_basesoc_cpu_ibus_cti;
		end
		default: begin
			builder_rhs_array_muxed42 <= main_basesoc_cpu_dbus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_rhs_array_muxed43 <= main_basesoc_cpu_ibus_bte;
		end
		default: begin
			builder_rhs_array_muxed43 <= main_basesoc_cpu_dbus_bte;
		end
	endcase
end
always @(*) begin
...
always @(posedge sys_clk) begin
	...
	main_a7ddrphy_dfi_p0_rddata_valid <= main_a7ddrphy_n_rddata_en6;
	main_a7ddrphy_dfi_p1_rddata_valid <= main_a7ddrphy_n_rddata_en6;
	main_a7ddrphy_dfi_p2_rddata_valid <= main_a7ddrphy_n_rddata_en6;
	main_a7ddrphy_dfi_p3_rddata_valid <= main_a7ddrphy_n_rddata_en6;
	...
	if ((main_sdram_sequencer_counter == 6'd55)) begin
		main_sdram_cmd_payload_a <= 1'd0;
		main_sdram_cmd_payload_ba <= 1'd0;
		main_sdram_cmd_payload_cas <= 1'd0;
		main_sdram_cmd_payload_ras <= 1'd0;
	...
	if (builder_csrbank2_dfii_pi0_address1_re) begin
		main_sdram_phaseinjector0_address_storage[14:8] <= builder_csrbank2_dfii_pi0_address1_r;
	end
	...
	if (builder_csrbank2_dfii_pi1_address1_re) begin
		main_sdram_phaseinjector1_address_storage[14:8] <= builder_csrbank2_dfii_pi1_address1_r;
	end
	...
	if (builder_csrbank2_dfii_pi2_address1_re) begin
		main_sdram_phaseinjector2_address_storage[14:8] <= builder_csrbank2_dfii_pi2_address1_r;
	end
	...
	if (builder_csrbank2_dfii_pi3_address1_re) begin
		main_sdram_phaseinjector3_address_storage[14:8] <= builder_csrbank2_dfii_pi3_address1_r;
	end
	...
	if (sys_rst) begin
		...
		main_basesoc_ram_bus_ram_bus_ack <= 1'd0;
		serial_tx <= 1'd1;
		main_basesoc_storage <= 32'd4947802;
		main_basesoc_re <= 1'd0;
		main_basesoc_sink_ready <= 1'd0;
		main_basesoc_uart_clk_txen <= 1'd0;
		main_basesoc_phase_accumulator_tx <= 32'd0;
		main_basesoc_tx_reg <= 8'd0;
		main_basesoc_tx_bitcount <= 4'd0;
		main_basesoc_tx_busy <= 1'd0;
		main_basesoc_source_valid <= 1'd0;
		main_basesoc_source_payload_data <= 8'd0;
		main_basesoc_uart_clk_rxen <= 1'd0;
		main_basesoc_phase_accumulator_rx <= 32'd0;
		main_basesoc_rx_r <= 1'd0;
		main_basesoc_rx_reg <= 8'd0;
		main_basesoc_rx_bitcount <= 4'd0;
		main_basesoc_rx_busy <= 1'd0;
		main_basesoc_uart_tx_pending <= 1'd0;
		main_basesoc_uart_tx_old_trigger <= 1'd0;
		main_basesoc_uart_rx_pending <= 1'd0;
		...
		main_sdram_phaseinjector0_address_storage <= 15'd0;
		...
		main_sdram_phaseinjector1_address_storage <= 15'd0;
		...
		main_sdram_phaseinjector2_address_storage <= 15'd0;
		...
		main_sdram_phaseinjector3_address_storage <= 15'd0;
