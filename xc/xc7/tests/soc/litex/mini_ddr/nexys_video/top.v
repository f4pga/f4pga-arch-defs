//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (--------) on 2020-04-15 15:56:01
//--------------------------------------------------------------------------------
module top(
...
reg [31:0] main_uart_phy_storage_full = 32'd4947802;
...
reg [3:0] main_a7ddrphy_half_sys8x_taps_storage_full = 4'd8;
...
reg [9:0] main_sdram_timer_count = 10'd782;
reg main_sdram_timer_load = 1'd0;
reg [9:0] main_sdram_timer_load_count = 10'd0;
...
always @(posedge sys_clk) begin
	...
	if (main_sdram_timer_wait) begin
		...
		main_sdram_timer_count <= 10'd782;
	end
	...
	if ((main_sdram_generator_counter == 3'd4)) begin
		main_sdram_cmd_payload_cas <= 1'd1;
		main_sdram_cmd_payload_ras <= 1'd1;
	end
	if ((main_sdram_generator_counter == 6'd56)) begin
	...
	if (sys_rst) begin
		...
		main_counter <= 2'd0;
		serial_tx <= 1'd1;
		main_uart_phy_storage_full <= 32'd4947802;
		...
		main_a7ddrphy_half_sys8x_taps_storage_full <= 4'd8;
