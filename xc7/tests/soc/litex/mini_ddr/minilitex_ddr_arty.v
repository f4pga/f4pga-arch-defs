//--------------------------------------------------------------------------------
// Auto-generated by Migen (562c046) & LiteX (9b11e919) on 2020-02-19 16:09:57
//--------------------------------------------------------------------------------
module top(
...
reg [31:0] main_minsoc_storage = 32'd4947802;
...
assign main_minsoc_uart_tx_fifo_syncfifo_din = {main_minsoc_uart_tx_fifo_fifo_in_last, main_minsoc_uart_tx_fifo_fifo_in_first, main_minsoc_uart_tx_fifo_fifo_in_payload_data};
...
assign main_minsoc_uart_rx_fifo_syncfifo_din = {main_minsoc_uart_rx_fifo_fifo_in_last, main_minsoc_uart_rx_fifo_fifo_in_first, main_minsoc_uart_rx_fifo_fifo_in_payload_data};
...
assign builder_minsoc_request = {main_minsoc_interface1_soc_bus_cyc, main_minsoc_interface0_soc_bus_cyc};
always @(*) begin
...
always @(posedge sys_clk) begin
	...
	if (sys_rst) begin
		...
		main_minsoc_sram_bus_ack <= 1'd0;
		serial_tx <= 1'd1;
		main_minsoc_storage <= 32'd4947802;
		main_minsoc_re <= 1'd0;
		main_minsoc_sink_ready <= 1'd0;
...
reg [9:0] memadr;
always @(posedge sys_clk) begin
	if (main_minsoc_sram_we[0])
		mem_1[main_minsoc_sram_adr][7:0] <= main_minsoc_sram_dat_w[7:0];
	if (main_minsoc_sram_we[1])
		mem_1[main_minsoc_sram_adr][15:8] <= main_minsoc_sram_dat_w[15:8];
	if (main_minsoc_sram_we[2])
		mem_1[main_minsoc_sram_adr][23:16] <= main_minsoc_sram_dat_w[23:16];
	if (main_minsoc_sram_we[3])
		mem_1[main_minsoc_sram_adr][31:24] <= main_minsoc_sram_dat_w[31:24];
